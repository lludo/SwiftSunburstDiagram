    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let configuration = SunburstConfiguration(nodes: [
            ...
            Node(name: "Restaurant", showName: false, image: UIImage(named: "eating"), value: 30.0, backgroundColor: .systemRed, children: [
                Node(name: "Dessert", showName: false, image: UIImage(named: "croissant"), value: 15.0, backgroundColor: .systemYellow),
                Node(name: "Dinner", showName: false, image: UIImage(named: "poultry"), value: 7.5, backgroundColor: .systemOrange),
            ]),
